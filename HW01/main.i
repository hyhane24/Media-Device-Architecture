...
void initialize() {
 ...
 bgColor = ((78) | (83)<<5 | (21)<<10);
 cColor = 0;
 fillScreen(bgColor);
 c1Color = 0;
 mColor = 0;
 c3Color = ((78) | (100)<<5 | (40)<<10);
 tColor = 0;
 t2Color = 0;
...
void update() {
 ...
 if (c1Col + c1Width > 240) {
  c1CDel *= -1;
 }
 if (c3Col <= 0) {
  c3CDel *= -1;
 }
 if (c3Col + c3Width > 240) {
  c3CDel *= -1;
 }
 if (tCol <= 0) {
  tCDel *= -1;
 ...
 if (collision(c3Col, c3Row, c3Width, c3Height, mCol, mRow, mWidth, mHeight)){
  c3CDel *= -1;
  if (mColor == 0){
   mColor = ((255) | (141)<<5 | (202)<<10);
   c1Color = ((255) | (141)<<5 | (202)<<10);
   cColor = ((255) | (141)<<5 | (202)<<10);
   tColor = ((255) | (141)<<5 | (202)<<10);
   t2Color = ((255) | (141)<<5 | (202)<<10);
  } else {
   mColor = 0;
   c1Color = 0;
   cColor = 0;
