...
void initGame() {
 ...
 (*(volatile unsigned short *)0x400000A) = (1 << 14) | ((0) << 2) | ((28) << 8);
    DMANow(3, gameOneTiles, &((charblock *)0x6000000)[0], 11584/2);
    DMANow(3, gameOneMap, &((screenblock *)0x6000000)[28], 4096/2);
 initPlayer();
    hOff = 5;
...
void initPlayer(){
 DMANow (3, spritesheetPal, ((unsigned short *)0x5000200), 512/2);
    ...
    spongeBob.cdel = 1;
    spongeBob.rdel = 1;
    spongeBob.col = 240/2 - (spongeBob.width/2);
    spongeBob.row = 160/2 - (spongeBob.height/2) + 36;
...
void updatePlayer(){
 ...
 shadowOAM[0].attr0 = spongeBob.row | (0 << 13) | (0 << 14);
    shadowOAM[0].attr1 = spongeBob.col | (2 << 14);
    shadowOAM[0].attr2 = ((spongeBob.curFrame*4)*32 + (spongeBob.aniState * 4)) | ((0) << 12);
}
