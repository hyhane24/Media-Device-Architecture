...
# 1 "rosie.h" 1
# 21 "rosie.h"
extern const unsigned short rosieTiles[16384];


extern const unsigned short rosiePal[256];
# 7 "main.c" 2
# 1 "start.h" 1
# 22 "start.h"
...
extern const unsigned int sfxSound_sampleRate;
extern const unsigned int sfxSound_length;
extern const signed char sfxSound_data[];
# 14 "main.c" 2
# 1 "startSong.h" 1
...
void goToGame() {
 ...
 DMANow(3, gameTiles, &((charblock *)0x6000000)[0], 14112 / 2);
...
void goToLose() {
 ...
 DMANow(3, loseTiles, &((charblock *)0x6000000)[0], 15104 / 2);
...
void initializeGame() {
    ...
    DMANow(3, rosiePal, ((unsigned short *)0x5000200), 512 / 2);
    DMANow(3, rosieTiles, &((charblock *)0x6000000)[4], 32768 / 2);
 ...
 bee.width = 16;
 bee.height = 16;
 bee.row = 160 / 2 - bee.height / 2;
 bee.col = 240 / 2 - bee.width / 2;
 bee.rdel = 3;
 bee.cdel = 3;
 bee.aniTimer = 0;
 bee.tileCol = 0;
...
void drawGame() {
 ...
 shadowOAM[0].attr0 = (rosie.row & 0xFF) | (0<<14) | (1<<13);
 shadowOAM[0].attr1 |= (rosie.col & 0x1FF) | (1<<14);
 shadowOAM[0].attr2 = ((rosie.tileRow)*32+(rosie.tileCol));

 shadowOAM[1].attr0 = ((rosie.row + 16) & 0xFF) | (1<<14) | (1<<13);
 shadowOAM[1].attr1 |= (rosie.col & 0x1FF) | (0<<14);
 shadowOAM[1].attr2 = ((rosie.tileRow + 2)*32+(rosie.tileCol));


 shadowOAM[2].attr0 = (bee.row & 0xFF) | (0<<14) | (1<<13);
 shadowOAM[2].attr1 = (bee.col & 0x1FF) | (1<<14);
 shadowOAM[2].attr2 = ((bee.tileRow)*32+(bee.tileCol));
}
