...
void initialize() {
 ...
 bgColor = 0;
 lColor = ((31) | (31)<<5 | (31)<<10);
 l2Color = ((31) | (31)<<5 | (31)<<10);
 cColor = ((31) | (31)<<5 | (31)<<10);
 mColor = ((31) | (31)<<5 | (31)<<10);
 tColor = ((0) | (31)<<5 | (0)<<10);
 t2Color = ((31) | (0)<<5 | (0)<<10);
 fillScreen(bgColor);
...
void update() {
 ...
 if (p2Col + p2Width > 240) {
  p2OldCol = p2Col;
  p2Col = (240 - 1) - (p2Width - 1);
 }
 if (p2Row < 0) {
  p2OldRow = p2Row;
  p2Row = 0;
 }
 if (p2Row + p2Height > 160) {
  p2OldRow = p2Row;
  p2Row = (160 - 1) - (p2Height - 1);
 }
...
void draw() {
 ...
 drawRect(pCol, pRow, pWidth, pHeight, ((31) | (31)<<5 | (31)<<10));


 drawRect(p2Col, p2Row, p2Width, p2Height, ((31) | (31)<<5 | (31)<<10));
