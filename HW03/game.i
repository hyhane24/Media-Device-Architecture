...
void drawGame() {
 ...
 drawCircle(cOldCol, cOldRow, cWidth, cHeight, ((255) | (51)<<5 | (51)<<10));
 drawCircle(cCol, cRow, cWidth, cHeight, ((31) | (31)<<5 | (31)<<10));
 ...
 void drawCannon() {
    ...
    drawRect(cannon.oldCol, cannon.oldRow, cannon.width, cannon.height,((255) | (51)<<5 | (51)<<10));
    drawRect(cannon.col, cannon.row, cannon.width, cannon.height, ((15) | (15)<<5 | (15)<<10));

    drawRect(0, 150, 240, 10, ((186) | (0)<<5 | (0)<<10));

    drawCircle(115,70,10,10,((31) | (31)<<5 | (31)<<10));



    if (ballsRemaining==4){
        drawCircle(115,70,2,2,((0) | (31)<<5 | (31)<<10));
    }
    if (ballsRemaining==3){
        drawCircle(115,70,4,4,((0) | (31)<<5 | (31)<<10));
    }
    if (ballsRemaining==2){
        drawCircle(115,70,6,6,((0) | (31)<<5 | (31)<<10));
    }
    if (ballsRemaining==1){
        drawCircle(115,70,8,8,((0) | (31)<<5 | (31)<<10));
    }
 ...
 void drawBullet(BULLET* b) {
    ...
    if(b->active) {
        drawRect(b->oldCol, b->oldRow, b->width, b->height, ((255) | (51)<<5 | (51)<<10));
...
void drawBall(BALL* b) {
    if(b->active) {
        drawCircle(b->oldCol, b->oldRow, b->width, b->height, ((255) | (51)<<5 | (51)<<10));
