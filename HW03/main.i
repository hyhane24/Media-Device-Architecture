...
void goToStart() {
    ...
    drawRect(0, 150, 240, 10, ((0) | (31)<<5 | (31)<<10));
    drawRect(0, 0, 240, 10, ((31) | (0)<<5 | (0)<<10));
    drawCircle(115,70,10,10,((31) | (31)<<5 | (31)<<10));
    drawCircle(115,70,4,4,((0) | (31)<<5 | (31)<<10));
    drawCircle(115,90,4,4,((31) | (0)<<5 | (0)<<10));
    drawCircle(115,50,4,4,((31) | (0)<<5 | (0)<<10));
    drawCircle(95,70,4,4,((31) | (0)<<5 | (0)<<10));
    drawCircle(135,70,4,4,((31) | (0)<<5 | (0)<<10));
    state = START;
}
