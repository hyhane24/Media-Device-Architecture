...
enum {BLACKID=(256-6), PORTAGEID, PERSIANID, VIOREDID, WHITEID, GRAYID, REDID, BLUEID};
...
# 1 "mushroom.h" 1
# 21 "mushroom.h"
extern const unsigned short mushroomBitmap[128];
...
# 1 "ghost.h" 1
# 21 "ghost.h"
extern const unsigned short ghostBitmap[128];


extern const unsigned short ghostPal[256];
# 6 "game.c" 2
...
void initGame() {
 ...
 mushroomCount = 1;
    ...
    unsigned short colors[6] = {0, ((18) | (19) << 5 | (27) << 10), ((0) | (21) << 5 | (20) << 10), ((28) | (8) << 5 | (16) << 10), ((31) | (31) << 5 | (31) << 10), ((15) | (15) << 5 | (15) << 10), ((31) | (0) << 5 | (0) << 10), ((0) | (0) << 5 | (31) << 10)};

 DMANow(3, mushroomPal, ((unsigned short *)0x5000000), 256);
...
void updatePlayer() {
 ...
 } else if ((~((*(volatile unsigned short *)0x04000130)) & ((1 << 4))) && player.col + player.width - 1 < 240 - player.cdel) {
  player.col = player.col + player.cdel;
        player.cDirection = 1;
 } else {
        player.cDirection = 0;
 ...
 if ((!(~(oldButtons) & ((1 << 0))) && (~buttons & ((1 << 0)))) && player.bulletTimer >= 1) {
  fireBullet();
